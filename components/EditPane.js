        ...
        <div ref={pane} className="fixed z-10 inset-0
            ...
            <div className="flex flex-col items-center gap-4">
                <button onClick={props.editContact}
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="w-10 h-10 fill-slate-500">
            ...
            <div className="flex flex-col items-center gap-4">
                <button onClick={props.editLinks}
                    ...
                    flex items-center justify-center animate-pulse
                    active:bg-black/[.15] transition-all duration-100">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" className="w-10 h-10 fill-slate-500">
            ...
            <div className="flex flex-col items-center gap-4">
                <button onClick={props.deleteContact}
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="w-10 h-10 fill-red-500">
