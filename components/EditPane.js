...
export default function EditPane(props) {
    ...
    useEffect(() => {
        ...
        // Delay fade-in to let Contact fade out first (240ms duration)
        ...
        <div ref={pane} className="fixed z-10 inset-0
            ...
            <div className="flex flex-col items-center gap-4">
                <button onClick={props.editContact}
                    ...
                    active:bg-black/[.15] transition-all duration-[240ms]">
                ...
                <span className="text-sm text-slate-600 uppercase tracking-widest leading-3">
                    Edit contact
                </span>
            </div>
            ...
            <div className="flex flex-col items-center gap-4">
                <button onClick={props.deleteContact}
                    ...
                    flex items-center justify-center animate-pulse
                    active:bg-red-500/[.15] transition-all duration-[240ms]">
                ...
                <span className="text-sm text-red-600 uppercase tracking-widest leading-3">
                    Delete contact
                </span>
            </div>
        </div>
